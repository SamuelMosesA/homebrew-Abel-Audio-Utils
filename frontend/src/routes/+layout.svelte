...
<main class="min-h-screen bg-background text-foreground selection:bg-primary/30 selection:text-primary-foreground font-sans antialiased overflow-x-hidden">
    ...
    <div class="fixed inset-0 overflow-hidden pointer-events-none z-0">
        ...
        <div class="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-amber-500/5 rounded-full blur-[120px]"></div>
    </div>

    <div class="relative z-10 w-full max-w-5xl mx-auto px-4 py-8 md:py-16">
        {@render children()}
    </div>

    <footer class="relative z-10 py-12 border-t border-border/20 backdrop-blur-sm mt-20">
        <div class="max-w-5xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-6 group">
            ...
            <div class="text-[10px] font-medium text-muted-foreground/60 uppercase tracking-widest">
